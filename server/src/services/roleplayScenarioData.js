...
const scenarios = {
  'drag-stage-1': { id: 'drag-stage-1', stageNumber: 1, mode: 'code', actorId: 'boss-byte', missionTitle: 'TRAINING: CHẠY HELLO WORLD', missionObjective: 'Gõ lại đoạn code mẫu và chạy thử để làm quen với việc viết chương trình.', context: 'Ngày đầu vào team. Boss Byte không bắt bạn biết code ngay. Anh muốn bạn hiểu cách một dòng lệnh tạo ra kết quả trên màn hình.', maxAttempts: 5, maxConversationTurns: 0 },
  'drag-stage-2': { id: 'drag-stage-2', stageNumber: 2, mode: 'code', actorId: 'boss-byte', missionTitle: 'FRESHER: NHẬN DỮ LIỆU VÀ HIỂN THỊ', missionObjective: 'Dùng input để nhận tên người dùng rồi in lời chào có tên đó.', context: 'Bạn đã chạy được chương trình đầu tiên. Boss Byte giao một bài gần với công việc hơn: chương trình phải nhận thông tin từ người dùng rồi hiển thị kết quả.', maxAttempts: 4, maxConversationTurns: 0 },
  'drag-stage-3': { id: 'drag-stage-3', stageNumber: 3, mode: 'code', actorId: 'qa-an', missionTitle: 'FRESHER: TÌM VÀ SỬA BUG', missionObjective: 'Chạy đoạn code lỗi, đọc thông báo lỗi, tìm nguyên nhân, sửa code và chạy lại.', context: 'Bạn đã biết viết và chạy code cơ bản. QA An gửi một đoạn code gần đúng nhưng đang lỗi ngay trước lúc demo.', maxAttempts: 5, maxConversationTurns: 0 },
