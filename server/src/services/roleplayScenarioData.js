...
const scenarios = {
  'drag-stage-1': { id: 'drag-stage-1', stageNumber: 1, mode: 'drag', actorId: 'boss-byte', missionTitle: 'TASK ĐẦU: ĐỪNG KÉO BỪA', missionObjective: 'Sắp xếp đúng luồng xử lý cơ bản: lấy dữ liệu, xử lý, rồi trả kết quả.', context: 'Ngày thử việc đầu tiên. Sếp muốn xem người chơi có biết nghĩ theo luồng chạy hay chỉ đoán cho qua màn.', correctSolution: ['input', 'input', 'add', 'print'], maxAttempts: 5, maxConversationTurns: 0 },
  'drag-stage-2': { id: 'drag-stage-2', stageNumber: 2, mode: 'drag', actorId: 'client-linh', missionTitle: 'KHÁCH ĐANG CHỜ FILE BÁO CÁO', missionObjective: 'Xử lý danh sách số liệu bằng quy trình lặp, không làm thủ công từng dòng.', context: 'Chị Linh cần báo cáo để họp. Khách hàng không quan tâm bạn dùng kỹ thuật gì, chỉ cần kết quả đúng và kịp.', correctSolution: ['input', 'loop', 'add', 'print'], maxAttempts: 4, maxConversationTurns: 0 },
  'drag-stage-3': { id: 'drag-stage-3', stageNumber: 3, mode: 'drag', actorId: 'qa-an', missionTitle: 'QA CHẶN RELEASE', missionObjective: 'Kiểm tra điều kiện trước khi xử lý để dữ liệu lỗi không lọt vào hệ thống.', context: 'QA An bắt được case lỗi ngay trước giờ demo. Nếu không kiểm tra điều kiện, lỗi sẽ trôi ra trước mặt khách.', correctSolution: ['array', 'loop', 'condition', 'add', 'print'], maxAttempts: 3, maxConversationTurns: 0 },
  ...
  'open-stage-5': openScenario('open-stage-5', 5, 'teammate-minh', 'ĐỒNG ĐỘI BỊ KẸT VÌ PHẦN CỦA BẠN', 'Giao tiếp rõ, chia việc rõ và không để đồng đội ngồi chờ mù mờ.', 'Minh đang cần phần logic của người chơi để làm tiếp giao diện.', 'Ê, phần của tớ đang kẹt vì phần của cậu. Mình chia lại việc sao cho kịp đây?'),
